...
console.log(
  new Date("2022-05-13 오전 11:26:58").format("yyyy-MM-dd a/p hh:mm:ss")
);
...
const convertToDiscussion = (obj) => {
  ...
  information.textContent = `${obj.author} / ${new Date(obj.createdAt).format(
